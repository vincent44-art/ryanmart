...
class OtherExpensesPDFResource(Resource):
    """Disabled PDF download endpoint.

    The UI/API should consume JSON responses only.
    """
    ...
    def get(self):
        return make_response_data(
            success=False,
            message="PDF downloads are disabled. Use the JSON endpoint to view other expenses.",
            status_code=410,
        )
