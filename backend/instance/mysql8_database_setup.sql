-- MySQL 8.0 database setup script for all 17 ORM tables with reserved keywords handled

DROP TABLE IF EXISTS sale, purchase, inventory, stock_movement, driver_expenses, message, gradients, receipts, spolige, it_event, other_expenses, it_alert, salaries, assignments, stock_tracking, seller_fruits, app_user;

-- Renamed 'user' table to 'app_user' to avoid reserved keyword conflict
...
CREATE TABLE seller_fruits (
  ...
  CONSTRAINT fk_seller_fruits_created_by FOREIGN KEY (created_by) REFERENCES app_user(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE sale (
  ...
  CONSTRAINT fk_sale_seller FOREIGN KEY (seller_id) REFERENCES app_user(id),
...
CREATE TABLE purchase (
  ...
  CONSTRAINT fk_purchase_purchaser FOREIGN KEY (purchaser_id) REFERENCES app_user(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE inventory (
  ...
  created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
  CONSTRAINT fk_inventory_added_by FOREIGN KEY (added_by) REFERENCES app_user(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE stock_movement (
  ...
  CONSTRAINT fk_stock_movement_user FOREIGN KEY (added_by) REFERENCES app_user(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE message (
  ...
  CONSTRAINT fk_message_recipient FOREIGN KEY (recipient_id) REFERENCES app_user(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE it_event (
  ...
  CONSTRAINT fk_it_event_user FOREIGN KEY (user_id) REFERENCES app_user(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE other_expenses (
  ...
  CONSTRAINT fk_other_expenses_user FOREIGN KEY (user_id) REFERENCES app_user(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE salaries (
  ...
  date DATE DEFAULT NULL,
  is_paid BOOLEAN DEFAULT FALSE,
  CONSTRAINT fk_salaries_user FOREIGN KEY (user_id) REFERENCES app_user(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE assignments (
  ...
  created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
  CONSTRAINT fk_assignments_seller FOREIGN KEY (seller_id) REFERENCES app_user(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
